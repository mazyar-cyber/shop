...
<head>
    ...
    {{--    <script src="{{asset('js/Dckeditor.js')}}" ></script>--}}
{{--    <script src="{{asset('js/4ckeditor.js')}}"></script>--}}
            ...
            <section class="sidebar">
              ...
              <i class="fa fa-angle-right pull-left"></i>
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li><a href="{{route('productProperty.create')}}"><i class="fa fa-plus"></i> اضافه نمودن
                                    مشخصه ی
                                    جدید
                                </a></li>
                        </ul>
              ...
              <i class="fa fa-angle-right pull-left"></i>
                        ...
                        <ul class="treeview-menu">
                            <li><a href="{{route('ProductPropertyValue.index')}}"><i class="fa fa-list-ol"></i> لیست
                                    مقادیر
                                    مشخصات محصولات</a>
                            </li>
                            <li><a href="{{route('ProductPropertyValue.create')}}"><i class="fa fa-plus"></i> اضافه
                                    نمودن
                                    مقدار جدید
                                </a></li>
                        </ul>
              ...
              <i class="fa fa-angle-right pull-left"></i>
                        ...
                        <ul class="treeview-menu">
                            <li><a href="{{route('email.index')}}"><i class="fa fa-list-ol"></i>
                                    لیست ایمیل ها</a>
                            </li>
                            <li><a href="{{route('email.create')}}"><i class="fa fa-plus"></i>ارسال ایمیل
                                </a></li>
                        </ul>
                    </li>


                    <li><a href="/admin/order"><i class="fa  fa-money"></i> <span>سفارشات</span></a></li>
